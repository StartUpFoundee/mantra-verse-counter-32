        ...
        <>
          ...
          <div className="h-[50vh] overflow-y-auto p-2 pt-safe-top">
            ...
            <div className="grid grid-cols-3 gap-1 mb-3">
              <ModernCard className="p-2 bg-gradient-to-br from-blue-400/20 to-cyan-500/20 border-blue-300/30 dark:border-blue-600/30" gradient>
                <div className="flex flex-col items-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center shadow-lg mb-1">
                    <Clock className="w-3 h-3 text-white" />
                  </div>
                  <div className="text-center">
                    <h3 className="text-xs font-semibold text-blue-600 dark:text-blue-400">Total</h3>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">{formatTimeSpent(stats.totalTime)}</div>
                  </div>
                </div>
              </ModernCard>

              <ModernCard className="p-2 bg-gradient-to-br from-green-400/20 to-emerald-500/20 border-green-300/30 dark:border-green-600/30" gradient>
                <div className="flex flex-col items-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center shadow-lg mb-1">
                    <Calendar className="w-3 h-3 text-white" />
                  </div>
                  <div className="text-center">
                    <h3 className="text-xs font-semibold text-green-600 dark:text-green-400">Active</h3>
                    <div className="text-lg font-bold text-gray-900 dark:text-white">{stats.activeDays}</div>
                  </div>
                </div>
              </ModernCard>
              ...
              <ModernCard className="p-2 bg-gradient-to-br from-purple-400/20 to-indigo-500/20 border-purple-300/30 dark:border-purple-600/30" gradient>
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-center">
                    <h3 className="text-xs font-semibold text-purple-600 dark:text-purple-400">Average</h3>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">{formatTimeSpent(stats.avgTime)}</div>
                  </div>
                </div>
              </ModernCard>
            </div>
            ...
            <ModernCard className="h-full p-3 bg-white/80 dark:bg-zinc-800/80 backdrop-blur-xl border-amber-200/50 dark:border-amber-700/50 flex flex-col" gradient>
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-lg font-bold text-gray-900 dark:text-white">Time Spent Calendar</h2>
                </div>
                <div className="flex items-center gap-2">
                  <Button
                  ...
                  {Array.from({ length: Math.ceil(monthData.days.length / 7) }).map((_, weekIndex) => (
                    monthData.days.slice(weekIndex * 7, (weekIndex + 1) * 7).map((dayData, dayIndex) => {
                      ...
                      return (
                        <div
                          key={dayData.date}
                          className={`aspect-square rounded-sm cursor-pointer transition-all duration-200 hover:ring-2 hover:ring-amber-400 relative flex items-center justify-center ${
