...
const SpiritualJourneyLevels: React.FC<SpiritualJourneyLevelsProps> = ({ activityData }) => {
  ...
  return (
    <div className="mb-4 md:mb-8 lg:mb-12 max-w-6xl mx-auto">
      <ModernCard className="p-4 md:p-6 lg:p-8 bg-white/90 dark:bg-zinc-800/90 backdrop-blur-xl border-amber-200/50 dark:border-amber-700/50" gradient>
        <div className="mb-4 md:mb-6">
          ...
          <p className="text-xs md:text-base text-gray-600 dark:text-gray-400">Your progress across different levels of spiritual practice</p>
        </div>

        {/* Mobile: 3-3-2 grid, Desktop: keep original 7 columns */}
            ...
            >
              <div className="flex flex-col items-center h-full justify-between">
                ...
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  <div className="text-[10px] md:text-xs opacity-75 mb-1 md:mb-2">{level.range}</div>
                </div>
                <div className="mt-auto">
                  <div className="font-bold text-sm md:text-lg">{level.days}</div>
                  <div className="text-[10px] md:text-xs opacity-75">days</div>
                </div>
              </div>
            </div>
          ))}
